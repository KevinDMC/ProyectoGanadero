<?php
    ...
    $sentencia = $dbh->prepare("SELECT * FROM fincas WHERE CodigoFinca = ?;");
    $resultado = $sentencia->execute([$CodigoFinca]);
    $Finca = $sentencia->fetch(PDO::FETCH_OBJ);
...
<body>
    <div class="modal-body">
        <form method="POST" action="EditarFinca.php" style="width:40%; margin-top:40px; margin-left:470px; border-radius:20px; padding:35px; background-color:rgba(0,0,0,0.4);">
            ...
            <div>
                ...
                <input type="text" name="CodigoFinca" class="form-control" value="<?php echo $Finca->CodigoFinca; ?>">
            </div>
            <br>
            <div>
                <label for="" style="color:white;">
                ...
                <input type="text" name="NombreFinca" class="form-control" style="border: 3px solid #555;" value="<?php echo $Finca->NombreFinca; ?>">
            </div>
            <br>
            <div>
                <label for="" style="color:white;">
                ...
                <input type="text" name="NombreVereda" class="form-control" style="border: 3px solid #555;" value="<?php echo $Finca->NombreVereda; ?>">
            </div>
            <br>
            <div>
                <label for="" style="color:white;">
